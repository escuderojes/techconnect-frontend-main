...
import { PagMainRecluComponent } from './reclutador/pag-main-reclu/pag-main-reclu.component';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, LoginComponent, RegisterEstuComponent, RegisterRecluComponent, PresentationComponent, PagMainEstuComponent, PagMainRecluComponent, ProfileEstuComponent, ActuDataEstuComponent, InserSkillEstuComponent, InserDataEstuComponent],
